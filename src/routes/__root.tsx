...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Paste any ingredient list and get an instant, evidence-based breakdown. Built by a molecular biologist." },
      { name: "author", content: "IngreDecode" },
      { property: "og:title", content: "IngreDecode - AI Ingredient Translator" },
      { property: "og:description", content: "Paste any ingredient list and get an instant, evidence-based breakdown. Built by a molecular biologist." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "IngreDecode - AI Ingredient Translator" },
      { name: "twitter:description", content: "Paste any ingredient list and get an instant, evidence-based breakdown. Built by a molecular biologist." },
